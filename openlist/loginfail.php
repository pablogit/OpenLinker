...
// ***************************************************************************
// ***************************************************************************
// Table users : bloc utilisé en cas d'erreur dans le login ou de droits insuffisants pour consulter certaines pages
require ("config.php");
echo "<ul><b><font color=\"red\">Vous n'êtes pas autorisé à acceder à cette page ou votre session a expiré</font></b><br />\n";
