...
echo "</style>\n";
echo "<style type=\"text/css\" media=\"all\">\n";
echo "@import url(\"css/calendar.css\");\n";
echo "</style>\n";
...
echo "<ul>\n";
echo "<li><b>".$monnom."</b>&nbsp;<a href=\"login.php?action=logout\" title=\"Logout\">[" . $logout[$lang] . "]</a></li>\n";
echo "| &nbsp;&nbsp;<li><a href=\"index.php\" class=\"selected\" title=\"" . $neworder[$lang] . "\">" . $neworder[$lang] . "</a></li>\n";
if (($monaut == "admin")||($monaut == "sadmin")||($monaut == "user"))
{
echo "| &nbsp;<li><a href=\"list.php?folder=in\" title=\"" . $inhelp[$lang] . "\">" . $inbox[$lang] . "</a></li>\n";
echo "<li><a href=\"list.php?folder=out\" title=\"" . $outhelp[$lang] . "\">" . $outbox[$lang] . "</a></li>\n";
echo "<li><a href=\"list.php?folder=all\" title=\"" . $allhelp[$lang] . "\">" . $allbox[$lang] . "</a></li>\n";
echo "<li><a href=\"list.php?folder=trash\" title=\"" . $trashhelp[$lang] . "\">" . $trashbox[$lang] . "</a></li>\n";
echo "| &nbsp;&nbsp;<li><a href=\"admin.php\" title=\"" . $adminhelp[$lang] . "\">" . $admindisp[$lang] . "</a></li>\n";
}
if ($monaut == "guest")
{
echo "<li><a href=\"list.php?folder=guest\" title=\"" . $myordershelp[$lang] . "\">" . $myorders[$lang] . "</a></li>\n";
}
